...
It contains only SMPP entities (PDU) and parsing so it could be reused on different platforms. It doesnt implement any networking, session handling and et cetera - its all up to you.
